...
flags.DEFINE_integer('buffer_size', 64, 'TF records dataset.')
...
def load(cfg, **unused_kwargs):
    ...
    if cfg.num_workers == 0:
        ...
        cfg.num_workers = 1
    del unused_kwargs
    if not os.path.exists(os.path.abspath(cfg.data_folder)):
