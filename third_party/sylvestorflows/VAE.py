...
import third_party.sylvestorflows.flows as flows
#from third_party.sylvestorflows.layers import GatedConv2d, GatedConvTranspose2d
    ...
    def create_encoder(self):
        ...
        if self.input_type == 'binary':
            q_z_nn = nn.Sequential(
                ...
                GatedConv2d(32, 64, 5, 2, 2),
                GatedConv2d(32, 64, 5, 1, 2),
                GatedConv2d(64, 128, 5, 2, 2),
...
class PlanarVAE(VAE):
    ...
    def __init__(self, z_size, input_size, nout,
                 enc_norm=None, dec_norm=None):
        super(PlanarVAE, self).__init__(z_size, input_size, nout,
                 enc_norm=None, dec_norm=None)
    ...
    def forward(self, x):
        ...
        stats = AttrDict(x=x_mean, mu_0=z_mu, sigma_0=z_var.sqrt(), z_0=z[0], z_k=z[-1], ldj=self.log_det_j)
...
class OrthogonalSylvesterVAE(VAE):
    ...
    def __init__(self, z_size, input_size, nout,
                 enc_norm=None, dec_norm=None):
        super(OrthogonalSylvesterVAE, self).__init__(z_size, input_size, nout,
                 enc_norm=None, dec_norm=None)
...
class HouseholderSylvesterVAE(VAE):
    ...
    def __init__(self, z_size, input_size, nout,
                 enc_norm=None, dec_norm=None):
        super(HouseholderSylvesterVAE, self).__init__(z_size, input_size, nout,
                 enc_norm=None, dec_norm=None)
...
class TriangularSylvesterVAE(VAE):
    ...
    def __init__(self, z_size, input_size, nout,
                 enc_norm=None, dec_norm=None):
        super(TriangularSylvesterVAE, self).__init__(z_size, input_size, nout,
                 enc_norm=None, dec_norm=None)
...
class IAFVAE(VAE):
    ...
    def __init__(self, z_size, input_size, nout,
                 enc_norm=None, dec_norm=None):
        super(IAFVAE, self).__init__(z_size, input_size, nout,
                 enc_norm=None, dec_norm=None)
    ...
    def forward(self, x):
        ...
        stats = AttrDict(x=x_mean, mu_0=z_mu, sigma_0=z_var.sqrt(), z_0=z_0, z_k=z_k, ldj=self.log_det_j)
        return x_mean, stats